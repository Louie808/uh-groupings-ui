...
public class GroupingsRestController {
     ...
     * Fetch a page of the specified Grouping.
     */
    @GetMapping(value = "/groupings/getListOfMembers/{path:.+}")
    public ResponseEntity<String> getListOfMembers(Principal principal,
            @PathVariable String path,
        ...
        logger.info("Entered REST grouping...");
        String baseUri = String.format(API_2_1_BASE + "/groupings/getListOfMembers/%s?", path);

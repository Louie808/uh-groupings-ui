...
public class UserDetailsServiceTest {
    ...
    public void construction() {
        MatcherAssert.assertThat(userBuilder, not(equalTo(null)));
    }
    ...
    public void testNonOwnerAdmin() {
        ...
        Assertions.assertFalse(user.hasRole(Role.OWNER));
    ...
    public void testAdminUser() {
        ...
        // Basics.
        MatcherAssert.assertThat(user.getUsername(), is("levia"));
        MatcherAssert.assertThat(user.getUid(), is("levia"));
        MatcherAssert.assertThat(user.getUhUuid(), is("89999999"));
    ...
    public void testOwner() {
        ...
        // Basics.
       MatcherAssert.assertThat(user.getUsername(), is("jjcale"));
       MatcherAssert.assertThat(user.getUid(), is("jjcale"));
       MatcherAssert.assertThat(user.getUhUuid(), is("90000000"));

        // Granted Authorities.
       MatcherAssert.assertThat(user.getAuthorities().size(), is(3));
        Assertions.assertTrue(user.hasRole(Role.ANONYMOUS));
        Assertions.assertTrue(user.hasRole(Role.UH));
        Assertions.assertTrue(user.hasRole(Role.OWNER));
    ...
    public void loadUserDetailsExceptionOne() {
        ...
        try {
            ...
            Assertions.fail("Should not have reached here.");
        } catch (Exception e) {
           MatcherAssert.assertThat(UsernameNotFoundException.class, is(e.getClass()));
           MatcherAssert.assertThat(e.getMessage(), containsString("principal is null"));
        }
    }
}
